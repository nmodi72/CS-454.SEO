...
import cs454.extractor.Crawler;
...
public class Extraction {
	...
	public static Map<String, String> extract(File f) throws IOException,
		...
		// TODO write the extractor as practice for homework...(not graded)
		// recommendation: make a list of metadata that is relevant to a file
